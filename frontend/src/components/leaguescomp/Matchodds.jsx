    ...
    matchOddsList?.[0]?.section?.map((sec) => {
      ...
      return {
        ...
        values: [
          ...
          { value: back1?.odds ?? "-", odds: back1?.size ?? "-", type: 'back', oname: 'back1' },
          { value: lay1?.odds ?? "-", odds: lay1?.size ?? "-", type: 'lay', oname: 'lay1' },
    ...
    <div className="py-2">
      <div className="bg-[#222424] h-10 p-2 pl-4 flex items-center gap-2 justify-between">
        <div className="flex items-center gap-2">
          <GrStarOutline className="text-white" />
          <span className="text-white font-bold">{t("bet.matchOdd")}</span>
        </div>
                  ...
                  <div
                    ...
                    onClick={() => {
                      ...
                      openBetSlip?.({
                        ...
                        max: getMarketMaxLimit(matchOddsList?.[0]),
                        sportSid: 4,
                        selectionId: team.sid,
                        marketId: matchOddsList?.[0]?.id || matchOddsList?.[0]?.mid,
                      });
                    }}
