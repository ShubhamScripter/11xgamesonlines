...
import spribeGames from '../spribe.json'
import { startCasinoGame, getCasinoWalletAmount } from '../../services/casinoService';import { getSpribeImage } from '../SpribePics'
import Spinner from '../Spinner'
function Latest() {
  const { user } = useSelector((state) => state.auth);
  const [loading, setLoading] = useState(false);
  
  // Get first 6 Spribe games for Latest
  const latestGames = spribeGames;
