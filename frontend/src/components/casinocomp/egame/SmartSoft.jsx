...
import spribeGames from '../../../components/api_json/smartsoft.json'
import { startCasinoGame, getCasinoWalletAmount } from '../../../services/casinoService';import { getSpribeImage } from '../../../components/SpribePics'
...
function smartSoft() {
  ...
  const atozGames = spribeGames.filter(game => game.game_type === 'XGames');
