...
function BetList() {
    ...
    const [tableData, setTableData] = useState(bettingDataSample);
    ...
    const mapBetStatusToSelectedVoid = (status) => {
      const s = (status || "").toLowerCase();
      if (s.includes("settled")) return "settel";
      if (s.includes("void")) return "void";
      if (s.includes("unmatched")) return "unsettel";
      if (s.includes("matched")) return "matched";
      if (s.includes("cancel")) return "cancelled";
      return "";
    };

    const effectiveLimit = () => {
      if (txnCount === "All") return 10000;
      const n = parseInt(txnCount, 10);
  ...
  return (
    <div className='mt-4 p-2 font-["Times_New_Roman"]'>
        ...
        <div className="flex items-center gap-4 mt-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="border border-[#aaa] shadow-[inset_0_2px_0_0_#0000001a] bg-[#fff]">
              <select className=" text-sm bg-white w-40 outline-0 " value={betStatus} onChange={(e)=>setBetStatus(e.target.value)}>
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="border border-[#aaa] shadow-[inset_0_2px_0_0_#0000001a] bg-[#fff]">
              <select className=" text-sm bg-white w-40 outline-0" value={txnCount} onChange={(e)=>setTxnCount(e.target.value)}>
                <option value="100">100 Tnx</option>
                <option value="200">200 Tnx</option>
      ...
      {/* Table Section */}
      <div className="mt-4">
        <BetListTable bettingData={tableData}/>
      </div>
    </div>
  );
}
