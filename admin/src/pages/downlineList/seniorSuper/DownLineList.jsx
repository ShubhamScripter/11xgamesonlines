...
import BalanceCard from "../../../components/downListComp/seniorSuper/BalanceCard";
import AccountTable from "../../../components/downListComp/seniorSuper/AccountTable";
import AddSubAdmin from "../../../components/downListComp/seniorSuper/AddSubAdmin";
      ...
      <div className="mt-4 flex justify-between items-center">
        ...
        <div className="flex  gap-2">
          ...
          >
            ...
            <span className="text-sm font-medium">Add Super Agent</span>
          </div>
